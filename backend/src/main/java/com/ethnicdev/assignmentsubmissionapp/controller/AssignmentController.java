...
import com.ethnicdev.assignmentsubmissionapp.dto.AssignmentResponseDto;
...
public class AssignmentController {
    ...
    public ResponseEntity<?> getAssignment(@PathVariable Long assignmentId, @AuthenticationPrincipal User user){
        Optional<Assignment> assignmentOptional = assignmentService.getAssignment(assignmentId, user);
